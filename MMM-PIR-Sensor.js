...
Module.register('MMM-PIR-Sensor',{
	...
	defaults: {
		...
		powerSavingMessage: "HDMI output will be turn Off by PIR module",
	...
	socketNotificationReceived: function (notification, payload) {
		if (notification === 'USER_PRESENCE') {
			...
			if  (payload === false && this.config.powerSavingNotification === true){
				msg = this.config.powerSavingMessage + " in " + this.config.powerSavingDelay.toString() + " s because there is no motion being detected"
